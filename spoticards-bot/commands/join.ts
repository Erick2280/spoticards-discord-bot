...
export function execute(message: Message, args: string[], server: Server, client) {
    ...
    message.channel.send(`Bem vindo ao jogo ${identifier}, ${message.author}! Assim que todo mundo estiver no jogo, distribua as cartas e comece o jogo enviando **.distribute**.`);
